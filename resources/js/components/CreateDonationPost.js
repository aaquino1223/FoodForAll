                    ...
                    <div className="row justify-content-end">
                        ...
                        <div className="dropdown mb-2 col-4 align-self-center">
                            ...
                            <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a className="dropdown-item" href="#">Associate Only</a>
                                <a className="dropdown-item" href="#">Associates & Followers</a>
                            </div>
                        </div>
                    </div>
                    <div className="form-group">
                        <input type="text" className="form-control" id="exampleTitle" maxLength="50"
                               aria-describedby="titleHelp" placeholder="Title/Subject"/>
                    </div>
                    <div className="form-group">
